package com.cakes.frameworks.utils.wx;
...
public class GetWxOrderno
{
  ...
  public static String getPayNo(String url,String xmlParam){
	  ...
	  System.out.println("请求是xml："+xmlParam);
     ...
     try {
	     ...
	     System.out.println("返回的json:"+jsonStr);
   ...
   * @see
   */
  public static Map getOrderChkResult(String url,String xmlParam){
